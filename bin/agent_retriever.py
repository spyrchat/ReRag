...
class ConfigurableRetrieverAgent:
    ...
    Simple interface for agents to retrieve documents.
    """
    ...
    def __init__(self, config_path: str, cache_pipeline: bool = True):
        ...
        logger.info(f"ConfigurableRetrieverAgent initialized with config: {config_path}")
    ...
    def _get_pipeline(self):
        ...
        if self._pipeline is None or not self.cache_pipeline:
            ...
            self._pipeline = RetrievalPipelineFactory.create_from_config(self._config)
    ...
    def switch_config(self, new_config_path: str):
        ...
        """
        logger.info(f"Switching configuration from {self.config_path} to {new_config_path}")
...
def demo_agent_usage():
    ...
    for config_name in configs:
        ...
        try:
            ...
            print(f"Stages: {config_info['num_stages']} ({', '.join(config_info['stage_types'])})")

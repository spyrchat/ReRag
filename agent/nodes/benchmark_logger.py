...
class BenchmarkLogger:
    ...
    def __init__(self, output_dir: str = "logs/benchmark", enabled: bool = True):
        ...
        if self.enabled:
            ...
            logger.info(f"[BenchmarkLogger] Initialized (output_dir={output_dir})")
        else:
    ...
    def log_execution(self, state: Dict[str, Any]) -> None:
        ...
        try:
            ...
            logger.error(f"[BenchmarkLogger] Failed to log execution: {str(e)}")
    ...
    def _serialize_documents(self, documents: list) -> list:
        ...
        for doc in documents:
            try:
                ...
                logger.warning(f"[BenchmarkLogger] Failed to serialize document: {str(e)}")
